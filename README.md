...
ظاهر Premium اختیاری: ۴۵ آیکون خطی Lucide با custom emoji ID و حالت `theme` برای دکمه‌های inline هماهنگ با تم تلگرام؛ متن و عملکرد دکمه‌ها تغییر نمی‌کند. [راهنمای آیکون‌ها، انتشار بسته و انتقال ربات](docs/BUTTON_ICONS.md).
