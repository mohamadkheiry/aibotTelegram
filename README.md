...
- منوی فارسی، بدون ایموجی در متن دکمه‌ها، با رنگ و آیکون سفارشی اختیاری.
...
- انبار، ویرایش امن payload، رزرو و تحویل خودکار موجودی آماده.
...
- مهلت پایه سفارش و intent کارت ۳۰ دقیقه است. اگر کاربر فیش کارت فرستاده باشد، پرداخت `verifying` تا حداکثر ۷ روز پس از پایان مهلت اولیه برای بررسی دستی نگه داشته می‌شود؛ invoice ارزی با deadline محلی terminal نمی‌شود و نتیجه provider مبناست.
