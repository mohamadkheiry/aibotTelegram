...
انتقال همهٔ داده‌ها و سوابق فعلی طبق [BOT_MIGRATION.md](BOT_MIGRATION.md) انجام شد. انتشار اولیه در ۲۰۲۶-۰۹-۰۶ ساعت ۱۳:۰۳:۴۶، فعال‌سازی آیکون در همان روز ساعت ۱۷:۴۶:۵۰ و آخرین راه‌اندازی با اصلاح recovery شبکه در **۲۰۲۶-۰۹-۰۷ ساعت ۱۳:۳۹:۲۹** به وقت Asia/Tehran روی همین میزبان Windows است. مبنای انتشار آیکون commit `594ff8f5c8809a54abd91a21d7b48012fbdcb144` بود؛ runtime فعلی علاوه بر آن اصلاح `_poll_batch` زیر را دارد. صرف تغییر تست/مستندات نیازمند restart نیست.
