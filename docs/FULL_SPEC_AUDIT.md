...
این گزارش شواهد ممیزی پیش از انتقال را نگه می‌دارد. ربات مقصد پس از این ممیزی به `@ElevenaccountsTestbot` منتقل شده است؛ وضعیت زنده، ۴۷۵ تست release جدید، اطلاع‌رسانی مدیران و مانع باقی‌ماندهٔ آیکون در [CURRENT_DEPLOYMENT.md](CURRENT_DEPLOYMENT.md) ثبت شده‌اند. اشاره‌های تاریخی این گزارش به مقصد قبلی، دستور انتشار تازه نیستند.
