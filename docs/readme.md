...
پیگیری ۲۰۲۶-۰۹-۲۶: [اتصال بلو و IR Crypto، رفع ابهام دامنه و پیش‌نیازهای باز](PAYMENT_ONBOARDING_2026-09-26.md). این سند گزارش بررسی است، نه انتشار یا فعال‌شدن پرداخت خودکار؛ مقصد ارزی مدنظر کارفرما IR Crypto است و اتصال اجرایی فعلی هنوز Plisio است.
