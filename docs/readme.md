...
به‌روزرسانی ۲۰۲۶-۰۹-۱۳: پاداش صریح محصول در هر بازه فقط یک قانون فعال دارد؛ ساخت و فعال‌سازی متداخل رد می‌شوند. [تصمیم‌ها و پاسخ‌های کارفرما](FINANCIAL_DECISIONS_2026-09-12.md) وضعیت تازه را از گزارش‌های تاریخی زیر جدا می‌کند. اولویت قواعد عمومی و جزئیات اضافه‌واریزی هنوز باز است.

تازه‌ترین پیگیری: [هشت گروه اصلاح رابط و تعیین تکلیف سه صوت](PENDING_FEEDBACK_2026-09-09.md). تصمیم کارفرما درباره زمان و مبنای پاداش اجرا شد: پاداش خرید پس از تحویل/فعال‌سازی است و درصد از قیمت کامل پیش از تخفیف، رو‌به‌پایین و با سقف اختیاری محاسبه می‌شود. جمع‌شدن قواعد و سیاست چندفیش هنوز تصمیم بازند. زمان و نتیجه استقرار فقط در وضعیت انتشار ملاک است.

ادامه گزارش‌های تازه: [شش گروه اصلاح پیگیری](FOLLOWUP_FEEDBACK_2026-09-08.md)، شامل انبار، جست‌وجوی سفارش، اطلاعات چندپیامی، قالب تحویل، شماره‌گذاری و پاداش زیر محصول. درصد/سقف و زمان واریز هنوز نیازمند تصمیم‌اند؛ گزارش صوتی پایین سابقه ممیزی اولیه است.

بررسی اولیه گزارش‌ها: [CLIENT_FEEDBACK_2026-09-08.md](CLIENT_FEEDBACK_2026-09-08.md)، شامل ۲۵ گروه اصلاح/بهبود و ۲۸ تست اختصاصی. [بررسی کامل سه صوت](VOICE_FEEDBACK_2026-09-08.md) وضعیت اولیه و به‌روزرسانی مسیر محصول را از درصد/سقف و تصمیم مالیِ باز جدا می‌کند. پیش از اعلام پایان به کارفرما این محدودیت‌ها را بخوانید.
...
افزوده جدید: [چیدمان دکمه‌های کاربران](CUSTOMER_LAYOUTS.md)، شامل پوشش ۴۳ نوع صفحه، الگوی مشترک/موردی، پیش‌نمایش، ترتیب فهرست‌ها، انتشار، واگرد و rollback. برای توسعهٔ هر صفحهٔ کاربر این قرارداد را نیز بخوانید؛ چیدمان اولیهٔ سند اکنون پیش‌فرض قابل تنظیم است.

تصمیم‌های مالی تکمیلی، موارد اجراشده و سؤال‌های باقی‌مانده در [FINANCIAL_DECISIONS_2026-09-12.md](FINANCIAL_DECISIONS_2026-09-12.md) ثبت شده‌اند.
...
فرم روش پرداخت، نام روش انتخاب‌شده و وضعیت فعلی آن را در مرحله تغییر، تأیید و نتیجه نشان می‌دهد؛ وضعیت جدید جداست و نقص پیکربندی کارت/رمزارز هشدار دارد. شرح UI-A05/UI-A06 در [BUTTON_UI_AUDIT.md](BUTTON_UI_AUDIT.md) و قرارداد در [BUTTON_UI.md](BUTTON_UI.md) است.

در صفحهٔ اول هر دو PDF فقط قابلیت خاموش/روشن ربات تعریف شده است، نه تعمیرات مستقل. رابط اکنون یک دکمهٔ وضعیت دارد و عنوان تکراری تعمیرات حذف شده است. نام آن متناسب با وضعیت فعلی، فعال/غیرفعال‌کردن است و پس از تأیید یک عمل معکوس دارد. قرارداد در [BUTTON_UI.md](BUTTON_UI.md) و اصلاح UI-A07 در [BUTTON_UI_AUDIT.md](BUTTON_UI_AUDIT.md) ثبت شده‌اند.

جوین اجباری اکنون فهرست کانال‌های ✅/❌ و صفحه سه‌دکمه‌ایِ هر کانال دارد؛ مسیر، استثنای محدود علامت وضعیت و آزمون‌ها در [ADMIN_JOINS.md](ADMIN_JOINS.md) است.
...
| [FULL_SPEC_AUDIT.md](FULL_SPEC_AUDIT.md) | مالک، QA، توسعه | در بازبینی سرتاسری تازه چه اصلاح شد و چه چیزهایی هنوز نیازمند آزمون زنده‌اند؟ |
...
گزارش بازبینی سرتاسری تازه در [FULL_SPEC_AUDIT.md](FULL_SPEC_AUDIT.md) و سابقهٔ ممیزی اولیه در [SPEC_AUDIT.md](SPEC_AUDIT.md) قرار دارد.
