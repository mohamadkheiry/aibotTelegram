...
افزوده جدید: [چیدمان دکمه‌های کاربران](CUSTOMER_LAYOUTS.md)، شامل پوشش ۳۹ نوع صفحه، الگوی مشترک/موردی، پیش‌نمایش، ترتیب فهرست‌ها، انتشار، واگرد و rollback. برای توسعهٔ هر صفحهٔ کاربر این قرارداد را نیز بخوانید؛ چیدمان اولیهٔ سند اکنون پیش‌فرض قابل تنظیم است.
