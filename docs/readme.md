...
دکمه‌های ربات و حالت تعمیرات متناسب با وضعیت فعلی، فعال/غیرفعال‌کردن را نشان می‌دهند؛ پس از تأیید نیز عمل معکوس در دسترس است. قرارداد در [BUTTON_UI.md](BUTTON_UI.md) و دو اصلاح UI-A03/UI-A04 در [BUTTON_UI_AUDIT.md](BUTTON_UI_AUDIT.md) ثبت شده‌اند.
