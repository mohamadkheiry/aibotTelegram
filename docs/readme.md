...
بررسی گزارش‌های جدید: [CLIENT_FEEDBACK_2026-09-08.md](CLIENT_FEEDBACK_2026-09-08.md)، شامل ۲۵ گروه اصلاح/بهبود، تفکیک سند از درخواست تازه، ۲۸ تست اختصاصی و موارد صوتی/مالی هنوز نیازمند تصمیم. پیش از اعلام پایان به کارفرما این محدودیت‌ها را بخوانید.
