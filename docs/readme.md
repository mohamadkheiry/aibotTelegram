...
تازه‌ترین پیگیری: [هشت گروه اصلاح رابط و تعیین تکلیف سه صوت](PENDING_FEEDBACK_2026-09-09.md). تبدیل بیرونی سه صوت کامل شد؛ تصمیم‌های مالی و گزارش لغو تخفیف هنوز بازند. زمان و نتیجه استقرار فقط در وضعیت انتشار ملاک است.
...
افزوده جدید: [چیدمان دکمه‌های کاربران](CUSTOMER_LAYOUTS.md)، شامل پوشش ۴۲ نوع صفحه، الگوی مشترک/موردی، پیش‌نمایش، ترتیب فهرست‌ها، انتشار، واگرد و rollback. برای توسعهٔ هر صفحهٔ کاربر این قرارداد را نیز بخوانید؛ چیدمان اولیهٔ سند اکنون پیش‌فرض قابل تنظیم است.
