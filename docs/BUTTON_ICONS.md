...
کنترل‌های پیگیری از همان manifest استفاده می‌کنند: پایان ارسال اطلاعات ← check، پاداش معرف محصول ← referral، سقف آیتم‌های انبار ← inventory. label بدون Unicode emoji، رنگ و action ثابت‌اند؛ بسته تازه‌ای منتشر نمی‌شود.
