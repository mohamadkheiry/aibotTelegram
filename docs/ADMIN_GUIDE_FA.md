...
تکمیل ۲۳ سپتامبر: مشخصات معرف مستقیم در جزئیات کاربر دیده می‌شود. برای کم/اضافه‌واریزی، «سفارش‌ها ← پرداخت‌ها ← تأیید فیش پرداخت ← مبلغ متفاوت؛ ثبت مبلغ واقعی» را انتخاب کنید و فقط پس از بررسی حساب بانکی مبلغ، پیگیری یکتا و دلیل را تأیید کنید. [راهنما، اولویت پاداش و مرز تأیید خودکار](CLIENT_DECISIONS_2026-09-23.md).

مسیرهای تازه و قواعد اطلاعات چندپیامی، شماره سفارش از 1000، پاداش زیر محصول و تفاوت سقف انبار با فروش دستی در [راهنمای پیگیری](FOLLOWUP_FEEDBACK_2026-09-08.md) آمده‌اند. برای پایان اطلاعات، مشتری باید دکمه پایان را بزند؛ مدیر تنها فایل‌های واقعی را از پیوست دریافت می‌کند.
...
از «مدیریت کلی ربات»، تنها دکمهٔ وضعیت را انتخاب کنید: وقتی ربات فعال است «غیرفعال‌کردن ربات» و وقتی غیرفعال است «فعال‌کردن ربات» می‌بینید. طبق سند، تعمیرات دکمه یا وضعیت مستقلی ندارد و عنوان تکراری قبلی حذف شده است. خاموش‌کردن دسترسی کاربران عادی را با پیام بروزرسانی می‌بندد؛ مدیران می‌توانند از همین پنل دوباره ربات را فعال کنند. خلاصهٔ وضعیت فعلی/مقصد را تأیید کنید؛ پس از اجرا/بازیابی یک دکمهٔ معکوس می‌آید. «لغو و بازگشت» تغییری نمی‌دهد. برای دیدن چیدمان تازه، منوی مدیریت را دوباره باز کنید؛ پیام‌های تاریخی ویرایش جمعی نمی‌شوند.
...
/user @username
/user ORDER_NUMBER
/user_orders CHAT_ID|@username [STATUS|all] [PAGE]
/user_orders CHAT_ID|@username order:ORDER_NUMBER
