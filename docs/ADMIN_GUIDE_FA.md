...
این راهنما برای مالک، مدیر و پشتیبان است. فرمان‌ها را فقط در گفت‌وگوی خصوصی با ربات بفرستید. برای دیدن خلاصه فرمان‌های مجاز نقش فعلی، `/admin_help` را بفرستید.
