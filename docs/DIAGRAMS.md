...
flowchart TB
    ...
    G -- بله --> B["۹ بخش و عملیات مجاز<br/>محصولات: دسته و سپس محصول<br/>ربات و تعمیرات: دکمه با هدف معکوس وضعیت فعلی"]
    ...
    Domain -- موفق --> Done["ثبت done و حذف secret از state<br/>پاسخ و navigation دکمه‌ای<br/>ربات و تعمیرات: وضعیت تازه و دکمهٔ معکوس"]
...
flowchart TB
    ...
    P --> Q["حذف metadata / حفظ callback، URL، contact و رنگ"]
    Q --> R["همان transport تلگرام / بدون poller دوم"]
```
