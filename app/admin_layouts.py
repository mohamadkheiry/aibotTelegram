...
class AdminLayouts:
    ...
    def preview_presentation(self, section, key):
        ...
        styles = {
            ...
            "order_summary": {"pay": "success", "discount": "primary", "cancel": "danger"},
            "payment_methods": {"wallet": "success", "card": "primary", "crypto": "primary", "cancel": "danger"},
            "order_cancel_confirm": {"confirm": "danger"},
